...
[原仓库打包目录 jsDelivr](https://testingcf.jsdelivr.net/gh/The-poem-of-destiny/FrontEnd-for-destined-journey/)
[现仓库打包目录 jsDelivr](https://testingcf.jsdelivr.net/gh/hyx0607/FrontEnd-for-destined-journey/)
## 添加预设数据
